...
class GameUI {
  ...
  _injectBattleStyles() {
    ...
    style.textContent = `
      ...
      .card-v3.mini.playable.selected{box-shadow:0 0 18px var(--dg)!important;transform:rotate(var(--rot)) translateY(-6px);filter:brightness(1.25)!important}
      /* === V13: 角色idle呼吸动画 === */
